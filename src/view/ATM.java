...
public class ATM extends JFrame {
	...
	public static JPanel views = new JPanel(new CardLayout());
	...
	public final static int WITHDRAW_VIEW_INDEX = 3;
	public final static int DEPOSIT_VIEW_INDEX = 4;
	public final static int TRANSFER_VIEW_INDEX = 5;
	public final static int INFORMATION_VIEW_INDEX = 5;
